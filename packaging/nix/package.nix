# 与 nixpkgs PR 559941 保持同步的打包定义。
# 上游发版后：更新 version/rev + cargoDeps hash（nix-build 报错中获取真实哈希）。
{
  lib,
  stdenv,
  fetchFromGitHub,
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-yaj+nVnUk2qk+mSW7nrYp4PQkrQf4/g193A3xSnFkaQ=";
  };

  cargoDeps = rustPlatform.fetchCargoVendor {
    inherit (finalAttrs) src cargoRoot;
    hash = "sha256-PMiE+XPrm9QRZbvrG3ND9bpSEtoHd633UyuPH2ye25M=";
  };
